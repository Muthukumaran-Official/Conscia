...
# Path to the banner inside resources folder (one level above current dir)
file_path = os.path.join(os.path.dirname(current_directory), "subenum", "SubEnum_banner.txt")
...
wordlist_path = os.path.join(os.path.dirname(current_directory), "subenum", "common_subs.txt")
try:
